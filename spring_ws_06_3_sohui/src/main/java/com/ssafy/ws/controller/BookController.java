...
public class BookController {
	...
	{
		User user2 = userService.getLoginUser(user);
		if (user2 != null) {
			logger.info("사용자명:" + user2.getName());
...
//		return "list";
	...
	public String doRegist(@ModelAttribute Book book, @RequestPart(required = false) MultipartFile file) throws IllegalStateException, IOException {
		...
		if(bookService.registBook(book)) return "regist_result";
		else return "redirect:/error/commonerr";
	}
