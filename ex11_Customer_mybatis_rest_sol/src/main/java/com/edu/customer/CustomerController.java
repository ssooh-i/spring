...
public class CustomerController {
	...
	public ResponseEntity<?> customerInsert(@RequestBody CustomerVO vo) throws Exception {
		try {
	...
	public ResponseEntity<?> list() throws Exception{
		try {
			return new ResponseEntity<List<CustomerVO>>(service.customerList(), HttpStatus.OK);
		}catch(Exception e) {
			return new ResponseEntity<String>("서버오류", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<?> searchCustomer(@PathVariable("id") String uid) throws Exception {
		try {
			return new ResponseEntity<CustomerVO>(service.customerSearch(uid), HttpStatus.OK);
		}catch(Exception e) {
			return new ResponseEntity<String>("서버오류", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	} 
	...
	@PutMapping("/customer")
	public ResponseEntity<?> customerUpdate(@RequestBody CustomerVO vo) throws Exception {
	      try {
